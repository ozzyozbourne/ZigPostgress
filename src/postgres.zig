...
pub extern fn PQgetline(conn: ?*PGconn, string: [*c]u8, length: c_int) c_int;
...
pub extern fn PQprint(fout: [*c]FILE, res: ?*const PGresult, ps: [*c]const PQprintOpt) void;
...
pub const OID_MAX = @compileError("unable to translate macro: undefined identifier `UINT_MAX`"); // /usr/include/postgresql/postgres_ext.h:39:9
pub const atooid = @compileError("unable to translate macro: undefined identifier `strtoul`"); // /usr/include/postgresql/postgres_ext.h:42:9
